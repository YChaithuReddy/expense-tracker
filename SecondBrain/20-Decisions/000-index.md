...
| ADR | Title | Status |
|---|---|---|
| [[001-Reuse-GAS-backend]] | Reuse Google Apps Script for attendance (not Supabase) | Accepted |
| [[002-Three-Tabs-Plus-Gear-Menu]] | Attendance shell: 3 tabs + gear for admin extras | Accepted |

class ExpenseTracker {
            ...
            <div class="modal-content batch-review-modal-content">
                <div class="modal-header">
                    <div class="batch-header__lead">
                        ...
                        <div class="batch-header__text">
                            <h2 class="batch-header__title">Review Scanned Bills</h2>
                            <p class="batch-header__subtitle">Verify details and submit the selected bills for reimbursement</p>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="batch-stats-container">
                        <div class="batch-stat-card" data-stat="total">
                            <div class="batch-stat-card__icon batch-stat-card__icon--blue" aria-hidden="true">
                            ...
                            <div class="batch-stat-card__body">
                                <div class="batch-stat-label">Total Bills</div>
                                <div class="batch-stat-value" data-stat-value="total">${totalBills}</div>
                                <div class="batch-stat-caption">Scanned bills</div>
                            </div>
                        </div>
                        <div class="batch-stat-card" data-stat="selected">
                            <div class="batch-stat-card__icon batch-stat-card__icon--green" aria-hidden="true">
                            ...
                            <div class="batch-stat-card__body">
                                ...
                                <div class="batch-stat-value success" data-stat-value="selected">${selectedBills}</div>
                                <div class="batch-stat-caption">Bills selected</div>
                            </div>
                        </div>
                        <div class="batch-stat-card" data-stat="amount">
                            <div class="batch-stat-card__icon batch-stat-card__icon--blue" aria-hidden="true">
                                <span class="batch-stat-card__rupee">₹</span>
                            </div>
                            <div class="batch-stat-card__body">
                                <div class="batch-stat-label">Total Amount</div>
                                <div class="batch-stat-value" data-stat-value="amount">₹${totalAmount.toFixed(2)}</div>
                                <div class="batch-stat-caption">From selected bills</div>
                            </div>
                        </div>
                        <div class="batch-stat-card" data-stat="review">
                            <div class="batch-stat-card__icon batch-stat-card__icon--amber" aria-hidden="true">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>
                            </div>
                            <div class="batch-stat-card__body">
                                <div class="batch-stat-label">Need Review</div>
                                <div class="batch-stat-value warning" data-stat-value="review">${failedOCR}</div>
                                <div class="batch-stat-caption">Bills need review</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="batch-actions-bar">
                        ...
                        <div class="batch-bulk-actions">
                            <span class="batch-bulk-actions__label">Apply project name to all:</span>
                            <div class="batch-bulk-actions__field">
                                <svg class="batch-bulk-actions__field-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                    ...
                    <!-- Verify info banner -->
                    <div class="batch-info-banner" role="note">
                        <span class="batch-info-banner__icon" aria-hidden="true">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
                        </span>
                        <span>Please verify all extracted details. You can edit any information before submitting.</span>
                    </div>
                </div>
                ...
                <div class="modal-footer batch-review-footer">
                    ...
                    <button class="btn-primary btn-submit" id="submitBatchBtn" type="button">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                        <span class="btn-submit__label">Submit ${selectedBills} Selected Bill${selectedBills !== 1 ? 's' : ''}</span>
                    </button>
                </div>
            </div>
        `;
    ...
    updateSubmitButton() {
        ...
        const submitBtn = document.getElementById('submitBatchBtn');
        if (!submitBtn) return;
        const label = submitBtn.querySelector('.btn-submit__label');
        const text = `Submit ${selectedCount} Selected Bill${selectedCount !== 1 ? 's' : ''}`;
...
This action <strong style="color:#ff4757">CANNOT</strong> be undone.</div>`;
    ...
    showWhatsAppOptions() {
        const existingModal = document.getElementById('whatsappOptionsModal');
        ...
        modal.innerHTML = `
            <div class="modal-content whatsapp-modal">
                <div class="modal-header">
                    ...
                    <button class="close-btn" onclick="document.getElementById('whatsappOptionsModal').remove()">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="quick-actions" style="flex-direction: column;">
                        <button class="btn btn-primary" onclick="expenseTracker.shareExpenseSummaryViaWhatsApp()" style="width: 100%; padding: 15px; margin-bottom: 10px;">
                            📊 Share Expense Summary
                        </button>
                        <button class="btn btn-secondary" onclick="expenseTracker.shareSelectedExpensesViaWhatsApp()" style="width: 100%; padding: 15px; margin-bottom: 10px;">
                            ✅ Share Selected Expenses
                        </button>
                        <button class="btn btn-outline" onclick="whatsappService.showSettingsModal(); document.getElementById('whatsappOptionsModal').remove();" style="width: 100%; padding: 15px;">
                            ⚙️ WhatsApp Settings
                        </button>
                    </div>
                </div>
    ...
    shareExpenseSummaryViaWhatsApp() {
        document.getElementById('whatsappOptionsModal')?.remove();

        if (this.expenses.length === 0) {
            this.showWarning('No expenses to share.', 'No Data');
            return;
        }
        ...
        message += `📝 Expenses: ${this.expenses.length}\n\n`;
        message += `📁 *By Category:*\n`;
        ...
        Object.entries(byCategory)
            ...
            .forEach(([cat, amount]) => {
                ...
                message += `  • ${cat}: ₹${amount.toFixed(2)} (${percent}%)\n`;
            });
    ...
    shareSelectedExpensesViaWhatsApp() {
        document.getElementById('whatsappOptionsModal')?.remove();

        const selectedExpenses = this.expenses.filter(exp => exp.selected);

        if (selectedExpenses.length === 0) {
            this.showWarning('No expenses selected.\n\nPlease select expenses using the checkboxes first.', 'No Selection');
            return;
        }

        const total = selectedExpenses.reduce((sum, exp) => sum + exp.amount, 0);

        let message = `📋 *Selected Expenses*\n\n`;

        selectedExpenses.forEach((exp, i) => {
            message += `${i + 1}. ${exp.description}\n`;
            message += `   💰 ₹${exp.amount} | 📁 ${exp.category}\n`;
            message += `   📅 ${new Date(exp.date).toLocaleDateString()}\n\n`;
        });
                        ...
                        return `
                            <article class="img-card" data-image-id="${img._id}" data-url="${img.url}" data-filename="${(img.filename || 'Bill Image').replace(/"/g, '&quot;')}">
                                ...
                                <div class="img-card__details">
                                    <div class="img-card__header-row">
                                    ...
                                    <div class="img-card__meta-row">
                                        <span class="img-card__meta">
                                            <svg class="img-card__meta-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        ...
                                        <span class="img-card__meta-dot">·</span>
                                        <span class="img-card__meta">
                                            <svg class="img-card__meta-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                                <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/>
                                                <polyline points="9 22 9 12 15 12 15 22"/>
                                            </svg>
                                            <span class="img-card__meta-value img-truncate">${img.originalExpenseInfo?.vendor || 'Unknown'}</span>
                                        </span>
                                    </div>
                                </div>
